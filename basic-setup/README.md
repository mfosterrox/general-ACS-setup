...
| `RHACS_VERSION` | — | Target version (e.g. `4.10`) |
...
| Current | Target | `RHACS_FORCE_DOWNGRADE` | Result |
|---------|--------|-------------------------|--------|
| 4.9.3 | (not set) | — | Uses installed version |
| 4.9.2 | 4.10 | — | Upgrades to 4.10 |
| 4.9.3 | 4.9.2 | false | Refuses downgrade |
| 4.9.3 | 4.9.2 | true | Downgrades |
